        ...
        <div className="panecontainer">
          ...
          <div className="bigpane" id="contactpane">
            ...
            <form className="feedbackform">
              <div className="formrow">
                <label htmlFor="feedback_name">Your name (optional)</label>
                <textarea id="feedback_name"></textarea>
              </div>
              <div className="formrow">
                <label htmlFor="feedback_comment">Comment</label>
                <textarea id="feedback_comment"></textarea>
              </div>
          ...
          <div className="bigpane" id="requestpane">
            ...
            <form className="requestform">
              <div className="formrow">
                <label htmlFor="request_requestedphoto">Photo Description</label>
                <textarea id="request_requestedphoto"></textarea>
              </div>
              <div className="formrow">
                <label htmlFor="request_email">Your email</label>
                <textarea id="request_email"></textarea>
              </div>
              <div className="formrow">
                <label htmlFor="request_comments">Additional Comments</label>
                <textarea id="request_comments"></textarea>
              </div>
              <div className="buttonrow">
